#include <stdio.h>
#define SIZE 8
#define clear() printf("\033[H\033[J") // Keep in mind that this method not compatible with all terminals 
...
int main() {
  ...
  */
  ...
  for(int i=1; i < 64; i++){
    while(1){
      printf("\nWhich move will you select, And if you see all move, you write 99 :");
      scanf("%d", &movement);
      if(movement == 99){
